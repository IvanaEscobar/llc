...
C HP 10/25/2018 I'M TURNING OFF 3D DIFFKR BECAUSE OF A PROBLEM WITH READING THE EXISTING BINARY
C o Allow full 3D specification of vertical diffusivity
#define ALLOW_3D_DIFFKR

CAB ADDING control for diffkr here, we need it earlier in domain
C#define ALLOW_DIFFKRLOG_CONTROL
...
C o new mixing inserted by JMC, but caused extensive recomp, now exlude
