...
dirRun=[dirScratch RunStr '/diags/'];if(~exist(dirRun));error('dirrun not exist');end;
...
flist_T={'0001635120','0001666080','0001645920'};
flist_S={'0001603080','0001696320'};
flist_U={'0001608480','0001662120','0001666800'};
flist_V={'0001622880','0001622520','0001643400','0001695960','0001598040','0001631880','0001697040','0001584720'};
...
%determining nz1 from meta file:
  ...
  dirOut=[dirRun varstrout{ivar} '_wet1/'];if(~exist(dirOut));mkdir(dirOut);end;
  ...
  clear flist
  eval(['flistp=flist_' varstrout{ivar}(1) ';']);
  for ifile=1:size(flistp,2);
    %tic
    flist(ifile).name=[varstrin{ivar} '.' flistp{ifile} '.data'];
