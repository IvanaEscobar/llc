...
dirIn='/scratch/atnguyen/aste_1080x1260x540x90/run_template/input_obcs/';
dirOut=dirIn;
...
% 1260+3*1080=4500
%uam = cat(2,uam1E,zeros(length(cl),padE3),-vam4E,-vam5E); % pad for face 3
str='';
