...
iy1=3*nx-ncut1+1:3*nx;                          %global [1981 3240]
...
ix5=3*nx-[iy1(end):-1:iy1(1)]+1;                %global [   1 1260]
...
iy1_0=[floor(iy1(1)/fac):ceil(iy1(end)/fac)];   %global [ 495  810]
...
ix5_0=sort(3*nx0-(iy1_0)+1);                    %global [   1  316]
