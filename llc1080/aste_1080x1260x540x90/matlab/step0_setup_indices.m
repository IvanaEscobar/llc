...
%5deg Atlantic
  ...
  %fieldIn0.pad=30+34;							%add 64 yc:[5.708538953235559N   6.015298779933335N]
%4.Jun.2018: make it more manual:
  yg0_f1=readbin([dirGrid0_global 'YG.data'],[nx0 nx0*3]);
  tmpj=find(yg0_f1(nx0/2,:)>=5.50);tmpj=tmpj(1);			%make it 514 for 1440x540
  fieldIn0.pad=tmpj-iy(1);						%64 for 1440x540, 19 for 1260x540
