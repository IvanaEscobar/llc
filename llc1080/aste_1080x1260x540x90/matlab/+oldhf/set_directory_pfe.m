...
datestamp=date;datestamp(find(datestamp=='-'))='';%'24Feb2017';%
fprintf('datestamp: %s\n',datestamp);
...
fBathyIn =[dirBathy 'bathy_aste' nxstr 'x' num2str(ncut1) 'x' num2str(ncut2) '_v1.bin'];
fBathyOut=[dirBathy 'bathy_aste' nxstr 'x' num2str(ncut1) 'x' num2str(ncut2) '_obcs' datestamp '_v1.bin'];

%=================== PARENT ========================================================
%directory of global llc270 
dirGrid0_global='/nobackupp2/atnguye4/llc270/global/run_template_llc270/';

%directory of ASTE llc270
dirRoot0=['/nobackupp2/atnguye4/MITgcm_c65q/mysetups/aste_270x450x180/'];
dirGrid0=[dirRoot0 'GRID_real8_fill9iU42Ef_noStLA/'];           %<-- use this for most up-to-date bathy, 3.feb.2017
...
RunStr='run_c65q_jra55_it0003_pk0000000002';RunStrShort='jra55i03';%2002-2015
