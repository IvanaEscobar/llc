...
%1%same as [nx,ncut1] = [1080  450]
%3%same as [nx,   nx] = [1080 1080]
%4%        [ncut2 nx] = [540  1080]
%5%        [ncut1 nx] = [450  1080]

%nx=1080;ncut1=450;ncut2=360;
niout = [  Lx1  Lx2 Lx3 Lx4   Lx5   Lx6];
njout = [  Ly1  Ly2 Ly3 Ly4   Ly5   Ly6];
niin  = [   nx   nx nx  nx*3  nx*3  0];
njin  = [ nx*3 nx*3 nx  nx    nx    0];

%looking for existing global mitgrid
